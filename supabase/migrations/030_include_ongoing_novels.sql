-- ============================================================
--  Writers Portal — Migration 030: Include Ongoing Novels
--  File: supabase/migrations/030_include_ongoing_novels.sql
--
--  SCOPE:
--    - Modifies get_featured_writer_public() and get_public_writers()
--    - Changes JOIN condition to include Ongoing novels if they have
--      at least one published episode.
--    - Does NOT change the RETURNS TABLE signature for either function.
-- ============================================================

-- 1. Update get_featured_writer_public() (from migration 029)
...
-- 2. Update get_public_writers() (from migration 022)
