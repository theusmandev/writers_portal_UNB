-- ============================================================
--  Writers Portal — Migration 036: Dual Publish Tracking Functions
--  File: supabase/migrations/036_dual_publish_tracking_functions.sql
-- ============================================================
...
-- 2. Recreate get_submission_by_code with UFB tracking fields
...
RETURNS TABLE (
  ...
  status_note     text,
  published_url   text,
  published_url_ufb text,
  resolved_published_url text,
  pen_name        text,
  full_name       text,
...
BEGIN
  ...
  SELECT
    ...
    s.published_url,
    s.published_url_ufb,
    resolve_published_url(s.published_url, s.published_url_ufb) AS resolved_published_url,
    w.pen_name,
    w.full_name,
    EXISTS (
...
-- 3. Recreate get_submissions_by_email with UFB tracking fields
